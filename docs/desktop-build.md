...
Để chạy code đang sửa, dùng `./run-desktop.sh` tại repository: UI dev riêng và Electron dùng đúng source hiện tại. Đây là luồng phát triển, không tạo bộ cài; muốn phân phối vẫn build theo các bước dưới.
